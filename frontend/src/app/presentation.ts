...
const LABELS: Record<string, string> = {
  ...
  ABERTO: "Aberto",
  LIVE: "Ao vivo",
  PRE_MATCH_ONLY: "Somente pré-jogo",
  LIVE_ENABLED: "Pré-jogo e ao vivo",
  ...
  NO: "Não",
  NONE: "Não ocorreu",
  HOME_DRAW: "Participante 1 ou empate",
  HOME_AWAY: "Qualquer participante",
  DRAW_AWAY: "Empate ou participante 2",
  AO_VIVO: "Ao vivo",
  ACTIVE: "Ativo",
  ATIVO: "Ativo",
